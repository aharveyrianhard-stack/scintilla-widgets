...
/* SESSION-FRESHNESS END */
  ...
  /* M57 ADDS A THIRD, ON PURPOSE. This list is checked PER ROW and a row outside it THROWS, which
  ...
  function geigerRows (symbols, map) {
    ...
    var rows = symbols.map(function (sym) {
      ...
      return {
        ...
        rsi14: value.daily_rsi14 == null ? null : Number(value.daily_rsi14),
        rsi_source_date: value.daily_rsi_as_of || null,
        rsi_state: value.daily_rsi_state || 'ABSENT',
        rungs: value.rungs || {},
