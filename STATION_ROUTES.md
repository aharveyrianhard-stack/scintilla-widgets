...
`tests/station-route-inventory.test.mjs`, the same way as the surfaces: **192 non-HTML files.**
...
| Supabase sources | 9 | edge-function and migration sources — served as text, never executed by the deploy |
