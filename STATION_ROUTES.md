...
`tests/station-route-inventory.test.mjs`, the same way as the surfaces: **72 non-HTML files.**
...
| Test suites (`*.test.mjs`) | 26 | the tests directory and the bridge draft's — served as text; they are the review evidence |
