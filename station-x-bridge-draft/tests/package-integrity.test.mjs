...
const knownV0716Blob = "d71db97a35252b1d5141e1751bc662569ce6065d";
...
test("Bridge package is the exact reviewed v0.7.16 manifest with unchanged permanent permissions", async () => {
  const source = await readFile(manifestPath);
  const manifest = JSON.parse(source.toString("utf8"));

  assert.equal(gitBlobHash(source), knownV0716Blob);
